...
def getLatestCabling():
   ...
   response = urlopen(url+path).read()
...
def filenameF(name):
    suffix='CablingInfo_Run'
    filenameX=suffix+name+'.txt'
    location = '/eos/cms/store/group/tracker-cctrack/www/CondDBMonitoringWebInterface/CondDBMonitoring/pro/CMS_CONDITIONS/DBTagCollection/SiStripFedCabling/SiStripFedCabling_GR10_v1_hlt/CablingLog/'
...
#        pattern = re.split('/', namelink)
#        filenameX = pattern[-1]
        location ='/eos/cms/store/group/tracker-cctrack/www/CondDBMonitoringWebInterface/CondDBMonitoring/pro/CMS_CONDITIONS/DBTagCollection/SiStripFedCabling/'
        #location = '/afs/cern.ch/user/j/jmejiagu/www/cablingfiles-bak/'
        #complete_route = location + filenameX
        #os.system (('cp %s .') % (complete_route))
#        return location + filenameX 
...
def CabHVFiles(fileCab,fileHV,verbose=True):
    ...
    OutFile=open('./output/'+filepsu.fname,'w')
...
if __name__ == "__main__":
    ...
    if (options.filenameC is None and options.fileurl is None):
        ...
        urlretrieve(url+path+cablingfile,cablingfile)
...
#FF        fileHV1='/afs/cern.ch/cms/slc6_amd64_gcc481/cms/cmssw/CMSSW_7_0_4/src/CalibTracker/SiStripDCS/data/StripPSUDetIDMap_BeforeJan132010.dat' 
    ...
    ## for the alias
#FF        StripDetIDAliasDict=pickle.load(open(os.getenv("CMSSW_RELEASE_BASE")+"/src/CalibTracker/SiStripDCS/data/StripDetIDAlias.pkl"))
        StripDetIDAliasDict=pickle.load(open("./cmssw//CMSSW_12_3_0_pre1/src/CalibTracker/SiStripDCS/data/StripDetIDAlias.pkl"))
    ...
    ##for the dictionary of the cabling file
     ...
     ##for the HV
        ...
        fileHV1='./cmssw//CMSSW_12_3_0_pre1/src/CalibTracker/SiStripDCS/data/StripPSUDetIDMap_BeforeJan132010.dat'
#FF        fileHV1='/afs/cern.ch/cms/slc6_amd64_gcc481/cms/cmssw/CMSSW_7_0_4/src/CalibTracker/SiStripDCS/data/StripPSUDetIDMap_BeforeJan132010.dat' 
        Myfilepsu=filepsu()
        MyCabHV=CabHVFiles(MyCabList,fileHV1,Myfilepsu)
        input5='/output/'+filepsu.fname
    ...
    if options.fileurl:
        ...
        ifile=open("./cmssw//CMSSW_12_3_0_pre1/src/CalibTracker/SiStripDCS/data/StripDetIDAlias.pkl", "rb")
    ## for the alias
#FF        StripDetIDAliasDict=pickle.load(open(os.getenv("CMSSW_RELEASE_BASE")+"/src/CalibTracker/SiStripDCS/data/StripDetIDAlias.pkl"))
        StripDetIDAliasDict=pickle.load(ifile)
